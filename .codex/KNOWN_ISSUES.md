...
- Status: design complete; implementation package 1 (storage primitives and shared classifier) is
  active, while runtime integration and migration remain deferred
