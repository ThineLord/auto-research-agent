...
```bash
cd /Users/hanzhiyou/GitHub_Repository/auto-research-agent
python3 -m venv .venv
...
- 启动本地图形界面
  - `cd /Users/hanzhiyou/GitHub_Repository/auto-research-agent && source .venv/bin/activate && streamlit run ui/app.py`
  - 或使用固定路径启动脚本：`/Users/hanzhiyou/GitHub_Repository/auto-research-agent/scripts/start_ui.sh`
...
- 启动：
  ...
  - 或直接运行：`/Users/hanzhiyou/GitHub_Repository/auto-research-agent/scripts/start_ui.sh`
- 路径检查：
  - UI 顶部会显示 `App root`
  - 正确路径应为 `/Users/hanzhiyou/GitHub_Repository/auto-research-agent`
- 选择模型：
