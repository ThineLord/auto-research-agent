...
Instructions:
1. Use the draft and review feedback together.
2. Prioritize fixing high-impact weaknesses first.
...
5. Explicitly convert review feedback into concrete edits.
6. For each roadmap item, include:
   - task
   - expected artifact (code/doc/experiment result)
7. Do not include process meta commentary.
