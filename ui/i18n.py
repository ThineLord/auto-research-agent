...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "stop_signal_failed": "Could not create stop signal at `{path}`. Move the stale path aside manually.",
        ...
        "run_meta_avg_revised_similarity": "Avg revised similarity to previous",
        "run_meta_low_change_rounds": "Low-change revised rounds",
        "run_meta_rubric_rounds": "Rubric rounds",
        "run_meta_rubric_avg_evaluation": "Avg evaluation rubric",
    ...
    "zh": {
        ...
        "stop_signal_failed": "无法在 `{path}` 创建安全停止信号。请先手动移开这个过期路径。",
        "project_tests": "项目测试",
        ...
        "run_meta_avg_revised_similarity": "修订稿相对上一轮平均相似度",
        "run_meta_low_change_rounds": "低变化修订轮次数",
        "run_meta_rubric_rounds": "Rubric 轮次数",
        "run_meta_rubric_avg_evaluation": "平均评估设计子分",
